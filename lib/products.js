...
export const PRODUCTS = [
  // Booms & Barriers
  { slug: "self-inflatable-oil-boom", cat: "Booms", brand: "Expandi", name: "Self-Inflatable Oil Boom",
    desc: "Pops open in seconds for rapid open-water encirclement — the original self-inflatable design, proven worldwide." },
  { slug: "floating-containment-boom", cat: "Booms", brand: "Parker Systems", name: "Floating Containment Boom",
    desc: "All-purpose PVC boom that links to any length to hold oil on the surface." },
  { slug: "permanent-harbour-boom", cat: "Booms", brand: "Parker Systems", name: "Permanent / Harbour Boom",
    desc: "Heavy-duty boom for fixed deployment at ports, outfalls and marinas." },
  { slug: "boom-hardware-accessories", cat: "Booms", brand: "Parker Systems", name: "Boom Hardware & Accessories",
    desc: "Connectors, anchors, tow bridles and reels for fast, reliable deployment." },
  { slug: "turbidity-silt-curtain", cat: "Booms", brand: "Parker Systems", name: "Turbidity / Silt Curtain",
    desc: "Controls suspended sediment during dredging and marine construction." },
  { slug: "dredge-barrier", cat: "Booms", brand: "Parker Systems", name: "Dredge Barrier",
    desc: "Robust barrier for containment around active dredging sites." },
  { slug: "baffle-boom", cat: "Booms", brand: "Parker Systems", name: "Baffle Boom",
    desc: "Directs and calms flow in channels, canals and water intakes." },
  // Skimmers
  { slug: "skimpak-skimmer", cat: "Skimmers", brand: "Parker Systems", name: "Skimpak Skimmer",
    desc: "Surface skimmer that recovers oil with minimal water pickup for low-waste cleanup." },
  { slug: "weir-skimmer", cat: "Skimmers", brand: "Parker Systems", name: "Weir Skimmer",
    desc: "Adjustable weir head for efficient recovery of floating product." },
  // Spill Kits
  { slug: "bagged-spill-kit", cat: "Kits", brand: "Parker Systems", name: "Bagged Spill Kit",
  ...
  { slug: "wheeled-drum-spill-kit", cat: "Kits", brand: "Parker Systems", name: "Wheeled / Drum Spill Kit",
    desc: "High-capacity mobile kit for larger industrial spill events." },
  { slug: "vehicle-truck-spill-kit", cat: "Kits", brand: "Parker Systems", name: "Vehicle & Truck Spill Kit",
    desc: "Compact kit for fleets transporting fuels or chemicals." },
  // Absorbents
  { slug: "absorbent-pads", cat: "Absorbents", brand: "Parker Systems", name: "Absorbent Pads",
    desc: "Oil-only and universal pads that lift oil — and, in universal form, other fluids — from water and hard surfaces." },
  { slug: "absorbent-socks", cat: "Absorbents", brand: "Parker Systems", name: "Absorbent Socks (Socs)",
    desc: "Flexible socks that snake around equipment and dike leaks to contain and soak up spills." },
  { slug: "absorbent-pillows", cat: "Absorbents", brand: "Parker Systems", name: "Absorbent Pillows",
    desc: "High-capacity pillows for soaking up pooled oil under drips, leaks and machinery." },
  { slug: "absorbent-booms", cat: "Absorbents", brand: "Parker Systems", name: "Absorbent Booms",
    desc: "Floating absorbent booms that corral and soak up oil on open water and around outfalls." },
  { slug: "oilsnare-singles", cat: "Absorbents", brand: "Parker Systems", name: "OilSnare Singles",
    desc: "Snares heavy, weathered oil that ordinary absorbents can't hold." },
  { slug: "oilsnare-on-a-rope", cat: "Absorbents", brand: "Parker Systems", name: "OilSnare on a Rope",
    desc: "Deployable rope of snares for shoreline and heavy-oil cleanup worldwide." },
  // Secondary Containment
  { slug: "spill-deck", cat: "Containment", brand: "Parker Systems", name: "Spill Deck",
    desc: "Low-profile platform that captures drum and container leaks at the source." },
  { slug: "spill-pallet", cat: "Containment", brand: "Parker Systems", name: "Spill Pallet",
    desc: "2- and 4-drum pallets with integral sump for compliant storage." },
  { slug: "drum-stacker", cat: "Containment", brand: "Parker Systems", name: "Drum Stacker",
    desc: "Stackable containment for dense, space-saving drum storage." },
  { slug: "containment-unit", cat: "Containment", brand: "Parker Systems", name: "Containment Unit",
    desc: "Modular containment for bulk storage and transfer areas." },
  { slug: "containment-berm", cat: "Containment", brand: "Parker Systems", name: "Containment Berm",
    desc: "Portable berm for vehicles, tanks and equipment." },
  { slug: "fuel-vent-bag", cat: "Containment", brand: "Parker Systems", name: "Fuel Vent Bag",
    desc: "Catches overfill from tank vents before it reaches the ground." },
  { slug: "drain-cover-seal", cat: "Containment", brand: "Parker Systems", name: "Drain Cover / Seal",
